...
[t,diaf] = ode45(@(t,diaf) odefun(t,diaf,r,F,Gamma,C,G,M,g,p0,kp,km,am1,am2,am3,am4,bm1,bm2,d), t, y0, options);
...
% Controller
function Controller = odefun(t,diaf,r,F,Gamma,C,G,M,g,p0,kp,km,am1,am2,am3,am4,bm1,bm2,d)
    % ======================================================
    % diaf_array:
    % (1) --> w1    (2) --> w2
    % (3) --> f1    (4) --> f2   (5) --> f3    (6) --> f4
    ...
    dx = A*x + B*(u - G*sin(diaf(11)) + d(t)); % real (non-linear) system for simulation
    dz = Am*z + Bm*r(t);
    dw1 = F*diaf(1) + g*u;
