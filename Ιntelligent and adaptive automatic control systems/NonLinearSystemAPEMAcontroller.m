...
[t,diaf] = ode45(@(t,diaf) odefun(t,diaf,r,C,G,M,aref1,aref2,aref3,aref4,bref1,bref2,g1,g2,g3,P), t, y0, options);
...
% Controller
function Controller = odefun(t,diaf,r,C,G,M,aref1,aref2,aref3,aref4,bref1,bref2,g1,g2,g3,P)
    % ======================================================
    % diaf_array:
    % (1) --> x1      (2) --> x2
    % (3) --> xref1   (4) --> xref2  
